...
<Callout type="info" title="Versions">
  Qeetrix is pre-1.0. The versions below are current at the time of writing; check npm for the
  latest before pinning.
</Callout>
...
<Card title="Components" href="/qeetrix/components" description="See everything @qeetrix/ui exports." />
