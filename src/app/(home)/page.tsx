      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl flex-col items-center px-6 py-20 text-center">
        ...
        >
          <span className="inline-flex items-center gap-1 rounded-full bg-brand-500 px-2 py-0.5 font-semibold text-[10px] text-brand-foreground uppercase">
            <SparklesIcon className="size-2.5" /> live
          </span>
          <span className="truncate">Qeet ID docs are shipping now</span>
        ...
        <p className="mt-6 max-w-2xl text-balance text-base text-fd-muted-foreground leading-8 sm:text-lg">
          Identity, people, and logs — one home for every product. Guides, API reference, SDKs, and
          operational playbooks, all searchable in one place.
        </p>
    ...
    <section className="bg-fd-background">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1fr_2fr] lg:py-24">
        <div className="flex flex-col gap-3">
          ...
          <h2 className="font-semibold text-3xl tracking-tight">From zero to shipped</h2>
          <p className="text-fd-muted-foreground">
            Qeet ID is live today. Start here, then bring People and Logs online as they ship.
          </p>
          <Link
            href="/id/quickstart"
            className="mt-2 inline-flex w-fit items-center gap-2 rounded-lg bg-brand-500 px-5 py-2.5 font-medium text-brand-foreground text-sm shadow-brand-500/25 shadow-lg transition-all hover:-translate-y-0.5 hover:bg-brand-600"
          >
